<h1 align="center" style="color: #417dff; font-size: 30px;">🍒 Chào mừng bạn đến với Hồ sơ GitHub của tôi</h1>
...
<p style="font-size: 21px; font-weight: bold; color: #FF1493; text-align: center;"> Biệt danh của tôi là Cherry, một cái tên vừa ngọt ngào vừa tràn đầy sức sống, phải không nào?</p>

<h3 style="color: #FF0080;">🔰 Kỹ sư phần mềm, lập trình viên, nhà nghiên cứu an ninh mạng.</h3>

<ul style="color: #E9FF23;">
  <li>🌍 Hiện tại, tôi đang sống và làm việc tại <span style="color: #FFFFFF;">Hải Phòng - Việt Nam</span>, nơi tôi tìm thấy nguồn cảm hứng vô tận cho công việc sáng tạo của mình.</li>
  <li>✉️ Bạn có thể liên hệ với tôi qua email <a href="mailto:iamkidtomboyreal@gmail.com" style="color: #0080FF;">iamkidtomboyreal@gmail.com</a> để hợp tác, trao đổi, hoặc chỉ là trò chuyện.</li>
  <li>🚀 Hiện tại, tôi đang tận dụng việc học và làm việc từ xa để khám phá những điều mới mẻ và sáng tạo.</li>
  <li>🧠 Những ngôn ngữ lập trình yêu thích của tôi là: <strong>Python, JavaScript, TypeScript, C</strong>, và tôi luôn cố gắng cải thiện kỹ năng của mình.</li>
  <li>🧩 Tôi luôn mở lòng với các dự án cộng đồng nơi tôi có thể đóng góp và học hỏi từ các đồng sáng tạo khác.</li>
</ul>

<h3 style="color: #FF0080;">⭐ Đối với tôi, GitHub không chỉ là một nền tảng mà là một phần trong hành trình!</h3>
...
<h3 style="color: #FF5733;">💻 Các công nghệ yêu thích:</h3>
...
<table style="width: 80%; table-layout: fixed; margin: 0 auto;">
  <tr>
    ...
    <td style="width: 50%; padding: 10px;">
      <h3>Framework và Thư viện yêu thích:</h3>
  ...
  <tr>
    <td style="width: 50%; padding: 10px;">
      <h3>Công cụ và Ứng dụng tôi sử dụng:</h3>
      <img src="https://skillicons.dev/icons?i=github,git,npm,docker,yarn" alt="Git, GitHub, NPM, Yarn, Docker" />
    </td>
    <td style="width: 50%; padding: 10px;">
      <h3>Cơ sở dữ liệu yêu thích:</h3>
      <img src="https://skillicons.dev/icons?i=mongodb,mysql,sqlite,postgresql,pycharm" alt="MongoDB, MySQL, SQLite, PostgreSQL, PyCharm" class="icon" />
    </td>
  </tr>
  <tr>
    <td style="width: 50%; padding: 10px;">
      <h3>Công cụ phát triển yêu thích:</h3>
      <img src="https://skillicons.dev/icons?i=vscode,neovim,sublime,eclipse,webstorm" alt="VS Code, Neovim, Sublime Text, Eclipse, Webstorm" class="icon" />
    </td>
    <td style="width: 50%; padding: 10px;">
      <h3>Hệ điều hành tôi sử dụng:</h3>
...
<h3 style="color: #FF69B4;">🌐 Các mạng xã hội tôi sử dụng:</h3>
...
<table style="width: 100%; table-layout: fixed; text-align: center;">
  <tr>
    ...
    <td style="padding: 5px;">
      <a href="https://t.me/Kidtomboy"><img src="https://img.shields.io/badge/Telegram-%23007BFF.svg?logo=telegram&logoColor=white" alt="Telegram"></a><br>
      <a href="https://tiktok.com/@Kidtomboy"><img src="https://img.shields.io/badge/TikTok-%23000000.svg?logo=TikTok&logoColor=white" alt="TikTok"></a><br>
      <a href="https://twitch.tv/Kidtomboy"><img src="https://img.shields.io/badge/Twitch-%239146FF.svg?logo=Twitch&logoColor=white" alt="Twitch"></a><br>
      <a href="https://twitter.com/Kidtomboy"><img src="https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white" alt="X"></a><br>
...
<p style="color: #4C00FF; display: flex; align-items: center;">
  ...
  P/s: Có một vài nền tảng tôi thích không liên kết ở đây; quá nhiều liên kết có thể khiến mọi thứ trở nên rối rắm! HAHA
</p>

---

<h3 style="color: #FF5100;">🥇 Thành tích trên GitHub:</h3>

<div style="text-align: center;">
  <img src="https://github-profile-trophy.vercel.app/?username=Kidtomboy&theme=radical&no-frame=false&no-bg=false&margin-w=4" alt="Thành tích GitHub" />
</div>
...
<table style="width: 100%; table-layout: fixed; text-align: center;">
  <tr>
    <td style="width: 50%; padding: 10px;">
      ...
      <img src="https://github-readme-streak-stats-seven-azure.vercel.app?user=Kidtomboy&theme=tokyonight-duo&hide_border=true&short_numbers=true&date_format=j%20M%5B%20Y%5D&mode=weekly" style="width: 100%; max-width: 400px;" /><br/>
...
<p style="font-size: 16px; color: #9F00FF;">
  Cảm ơn bạn đã ghé thăm hồ sơ của tôi! Mỗi lượt xem không chỉ là một con số, mà là một động lực để tôi tiếp tục sáng tạo và học hỏi. Hy vọng những gì tôi chia sẻ sẽ mang lại giá trị cho bạn. 💛
</p>

![Số lượt xem](https://komarev.com/ghpvc/?username=Kidtomboy&color=blue)

<h3 style="color: #0084ff;">🌸 Xem con rắn ăn những đóng góp trên GitHub:</h3>

<p style="font-size: 16px; color: #00FF00;">
  Bạn có thấy con rắn dễ thương này không? Đó là một cách thú vị để hiển thị các đóng góp của tôi trên GitHub. Mỗi ô vuông được lấp đầy đại diện cho một giọt mồ hôi trong hành trình học hỏi và phát triển của tôi. Nếu bạn cũng có đóng góp, đừng ngần ngại chia sẻ liên kết GitHub của bạn, tôi rất vui được ghé thăm! 🌟
</p>

![Gif con rắn](https://github.com/Kidtomboy/Kidtomboy/blob/output/github-contribution-grid-snake-dark.svg)
...
<p style="font-size: 16px; color: #E9FF23;">
  Nếu bạn thích những gì tôi làm và muốn hỗ trợ tôi, bạn có thể đóng góp qua các nền tảng sau:
</p>
